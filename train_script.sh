...
export CUDA_VISIBLE_DEVICES=0,1,2,3&&torchrun --standalone --nproc_per_node 4 --rdzv_backend c10d train.py --dataset multifingerprintdataset --root /home/jzj/projects/rpp-xli135/jzj/datasets --distributed
